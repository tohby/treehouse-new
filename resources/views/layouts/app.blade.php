                ...
                <div class="gf_flex menu_content">
                    ...
                    <div class="gf_flex nav_menu">
                        <ul class="gf_flex menu_left">
                            <li class="{{ request()->is('store') || request()->is('store/*') ? 'active' : '' }}">
                                <a href="/store" class="{{ request()->is('store') || request()->is('store/*') ? 'active' : '' }}">Store</a>
                            </li>
                            {{-- <li>
                                <a href="#">News</a>
                            </li> --}}
                            <li class="{{ request()->is('our-events') || request()->is('our-events/*') ? 'active' : '' }}">
                                <a href="/our-events" class="{{ request()->is('our-events') || request()->is('our-events/*') ? 'active' : '' }}">Events</a>
                            </li>
                        </ul>
