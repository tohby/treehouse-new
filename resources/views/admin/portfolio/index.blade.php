                ...
                @foreach ($portfolios as $item)
                    <div class="col-md-3">
                        <div class="card border-0 bg-white">
                            <img src="/storage/post_images/{{$item->images->first()->image}}" class="card-img-top news-img rounded-lg" alt="{{$item->title}}">
                            <div class="card-body px-0 px-2">
                                    <a href="/portfolio/{{$item->id}}" class="stretched-link">
